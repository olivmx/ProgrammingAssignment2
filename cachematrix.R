...
## setsinverse: sets the inverse matrix of matrix
...
## cacheSolve
## recieves the result of first function
## returns the inverse of the matrix fed to the first function either by
